...
| Builtin commands | 532 (enforced by `tests/validation/check_builtin_count.sh`) |
...
Every release also ships a SHA-256 manifest signed with the project's Ed25519 key, fingerprint `D2429030802BE314`. The public key lives at [zy-release.pub](zy-release.pub) in this repo. For the 5-second `minisign + sha256sum -c` verification recipe, see [docs/ops/RELEASE_SIGNING.md](docs/ops/RELEASE_SIGNING.md).
</details>
