<!--
  ...
  scripts/publish-release.sh extracts THIS file into the public mirror's
...
Every release also ships a SHA-256 manifest signed with the project's Ed25519 key, fingerprint `D108A9B9CA11369C`. The public key lives at [zy-release.pub](zy-release.pub) in this repo. For the 5-second `minisign + sha256sum -c` verification recipe, see [docs/RELEASE_SIGNING.md](docs/RELEASE_SIGNING.md).
</details>

Full repository policy and removal steps: [docs/APT_REPOSITORY.md](docs/APT_REPOSITORY.md).
